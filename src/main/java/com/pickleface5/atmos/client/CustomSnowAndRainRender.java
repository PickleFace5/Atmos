...
public class CustomSnowAndRainRender implements IWeatherRenderHandler {
    private final float[] rainSizeX = new float[1024];
    private final float[] rainSizeZ = new float[1024];
    private static final ResourceLocation RAIN_LOCATION = new ResourceLocation("textures/environment/rain.png"); //TODO: make rain appear
        ...
        if (!(f <= 0.0F)) {
            ...
            for(int j1 = k - l; j1 <= k + l; ++j1) {
                for(int k1 = i - l; k1 <= i + l; ++k1) {
                    ...
                    //BetterClouds.LOGGER.debug("Cam pos: {} {} {}", camX, camY, camZ);
                    //BetterClouds.LOGGER.debug("Rendering rain at pos: {} {} {}", (double)k1, camY, (double)j1);
                    ...
                    if (biome.getPrecipitation() != Biome.Precipitation.NONE) {
                        ...
                        if (j2 != k2) {
                            ...
                            if (biome.warmEnoughToRain(blockpos$mutableblockpos)) {
                                ...
                                //BetterClouds.LOGGER.debug("render rain vertexes at y pos: {}", f2);
